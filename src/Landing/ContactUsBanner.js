...
function ContactUsBanner(props) {
  return (
    <>
      <section className="vh-100 overflow-hidden bg-gray-50 sm:grid xl:grid-cols-2 sm:items-center">
        <div class="p-8 md:p-12 lg:px-16 lg:py-24">
          <div class="vh-50 mx-auto max-w-2xl text-center ltr:sm:text-left rtl:sm:text-right">
